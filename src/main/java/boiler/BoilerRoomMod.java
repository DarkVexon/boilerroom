...
import boiler.cards.AbstractEasyCard;
import boiler.events.*;
import boiler.monsters.*;
import boiler.monsters.special.GnatMonsterGroup;
import boiler.monsters.special.GnatSkittlerGroup;
import boiler.relics.AbstractEasyRelic;
...
public class BoilerRoomMod implements EditCardsSubscriber, EditRelicsSubscriber, EditStringsSubscriber, EditKeywordsSubscriber, PostInitializeSubscriber {
    ...
    public void receivePostInitialize() {
        ...
        BaseMod.addMonster("boiler:TwoPotsAndWorm", "Two Pots and Worm", () -> new MonsterGroup(new AbstractMonster[]{
                new PotThing(-200, 0, false),
                new PotThing(0, 0, true),
                new Worm(175, 10)
        }));
